...
export const BENCH_ITEMS = {
  ...
  wings_ember: {"type":"armor","refinable":false,"stack":1,"id":"wings_ember","name":"Artaria Wings","nameTh":"ปีกเปลวอังคาร","slot":"wings","level":50,"weight":8,"value":380000,"rarity":"legendary","wing":{"style":"ember","scale":1.1},"stats":{"str":3,"agi":3},"atk":12,"speed":4,"desc":"ไฟที่ไม่ไหม้เจ้าของ — แต่ไหม้ทุกอย่างที่เข้ามาใกล้"},
