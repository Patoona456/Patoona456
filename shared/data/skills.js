...
export const SKILLS = {
  ...
  ember_arrow: S({
    ...
    weapon: ['bow'], ammo: 1, element: 'ember',
  ...
  ember_bolt: S({
    ...
    anim: 'spellcast', magic: true, element: 'ember', desc: 'เวทย์ไฟพื้นฐาน ร่ายเร็ว',
  }),
  frost_nail: S({
    ...
    anim: 'spellcast', magic: true, element: 'frost',
  ...
  storm_sigil: S({
    ...
    cooldown: [12, -0.5], anim: 'spellcast', magic: true, element: 'storm', hits: [2, 0.5],
  ...
  meteor_rune: S({
    ...
    element: 'ember', desc: 'อุกกาบาตตกซ้ำๆ ในพื้นที่กว้าง',
  }),
  glacial_field: S({
    ...
    element: 'frost', status: { type: 'chill', chance: [100, 0], duration: [2, 0], slowPct: [40, 4] },
  ...
  chain_spark: S({
    ...
    castTime: 0.8, cooldown: [8, -0.3], anim: 'spellcast', magic: true, element: 'storm',
  ...
  thunder_step: S({
    ...
    cooldown: [14, -1.5], anim: 'spellcast', magic: true, element: 'storm',
  ...
  oath_strike: S({
    ...
    element: 'radiant', desc: 'ดาเมจกายภาพธาตุแสง',
  }),
  consecrate: S({
    ...
    cooldown: [30, -1], anim: 'spellcast', magic: true, element: 'radiant',
