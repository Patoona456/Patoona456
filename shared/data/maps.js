...
export const MAPS = {
  emberhold: {
    ...
    npcs: [
      { id: 'vendor', name: 'พ่อค้าเมล', role: 'shop', x: 26, y: 22, shop: 'general', look: { body: 'female/light', hair: 'ponytail/brown', torso: 'shirt_teal', legs: 'pants_white', feet: 'shoes_black' } },
      { id: 'smith', name: 'ช่างตีเหล็กบอร์ก', role: 'smith', x: 39, y: 22, look: { body: 'male/dark', hair: 'messy/black', torso: 'leather', legs: 'pants_red', feet: 'metal', hands: 'metal_gloves' } },
      { id: 'banker', name: 'ผู้ดูแลคลังลีน่า', role: 'storage', x: 26, y: 31, look: { body: 'female/tanned', hair: 'long/black', torso: 'shirt_white', legs: 'pants_white', feet: 'shoes_black' } },
      { id: 'broker', name: 'นายหน้าคาสเซล', role: 'market', x: 39, y: 31, look: { body: 'male/light', hair: 'plain/blonde', torso: 'shirt_maroon', legs: 'pants_teal', feet: 'shoes_brown', head: 'cloth_hood' } },
      { id: 'healer', name: 'นักบวชอีริน', role: 'healer', x: 32, y: 19, look: { body: 'female/light', hair: 'plain/white', torso: 'shirt_white', legs: 'pants_white', feet: 'shoes_black', head: 'cloth_hood' } },
      { id: 'guide', name: 'ครูฝึกฮาลด์', role: 'trainer', x: 32, y: 33, look: { body: 'male/tanned', hair: 'ponytail/black', torso: 'chain', legs: 'metal', feet: 'metal', weapon: 'spear' } },
      { id: 'warper', name: 'นักเดินทางวิน', role: 'warp', x: 45, y: 26, look: { body: 'male/darkelf', hair: 'long/white', torso: 'shirt_maroon', legs: 'pants_white', feet: 'shoes_black' } },
      { id: 'board', name: 'กระดานภารกิจ', role: 'quests', x: 20, y: 26, look: null },
    ],
    spawns: [],
  },
