...
Real-ESRGAN (x4plus, 4x) and sharpened. Buildings are stored at 4x as WebP; the ground is cut into 512px tiles of the 4x picture (assets/maps/emberhold/ground, 2px bleed) plus a 1x WebP used as placeholder and minimap.
